        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse menu-ngang" id="navbarSupportedContent">
                ...
                <form name="frmSearch" id="frmSearch" class="form-inline my-2 my-lg-0" action="/nguyenanhthoai/fontend/pages/search.php" method="get">
                    <input class="form-control mr-sm-2 TimKiem" style="width:190px" type="search" placeholder="Tìm sản phẩm, thương hiệu bạn muốn mua..." aria-label="Search" name="search">
                  <button class="btn btn-outline-secondary my-2 my-sm-0 mr-5 btn-TimKiem" type="submit" id="submit" name="submit">Tìm Kiếm</button>
                </form>
                <!-- menu ngang bên phải -->
                <ul class="navbar-nav">
                    <li class="nav-item">
