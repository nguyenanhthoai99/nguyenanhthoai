...
<body>
    ...
    WHERE sp.lsp_ma = 1 AND sp.sp_sanphamhot IS NULL AND sp.sp_slider IS NULL
...
OTE;
    ...
    <div class="container mt-5 main-table">
        ...
        <table class="table table-bordered table-hover mt-2 text-center" id="tblDanhsach" border="1">
            ...
            <tbody>
                <?php foreach ($dataDienThoai as $data) : ?>
                    <tr>
                        <td><?= $data['sp_ma'] ?></td>
                        <td><?= $data['sp_ten'] ?></td>
                        <td style="width:500px">
                            <img src="/nguyenanhthoai/fontend/images/dienthoai/<?= $data['sp_hinh']; ?> " class="img-fluid" style="width:100px; height:70px;">
                        </td>
                        <td style="width:500px">
                            <img src="/nguyenanhthoai/fontend/images/dienthoai/<?= $data['sp_hinhchitiet']; ?> " class="img-fluid" style="width:100px; height:70px;">
                        </td>
