...
<body>
    ...
    WHERE sp.lsp_ma = 2 AND sp.sp_sanphamhot IS NULL AND sp.sp_slider IS NULL AND sp.sp_quangcao IS NULL
                ...
                <?php foreach ($dataLaptop as $data) : ?>
                    <tr>
                        ...
                        <td style="width:500px">
                            <img src="/nguyenanhthoai/fontend/images/laptop/<?= $data['sp_hinh']; ?> " class="img-fluid" style="width:100px; height:70px;">
                        </td>
                        <td style="width:500px">
                            <img src="/nguyenanhthoai/fontend/images/laptop/<?= $data['sp_hinhchitiet']; ?> " class="img-fluid" style="width:100px; height:70px;">
                        </td>
