...
<!DOCTYPE html>
<html lang="en">
<title>Laptop giá rẻ nhất - Laptop Vesper Nguyễn Mobile </title>
<?php
include_once(__DIR__ . '/../../dbconnect.php');
$sql = <<<OTE
SELECT sp.sp_ma, sp.sp_ten, sp.sp_gia, sp.sp_giacu, km.km_qua, sp.sp_hinh, sp.sp_quangcao
FROM sanpham sp
JOIN khuyenmai km ON km.km_ma = sp.km_ma
WHERE sp.lsp_ma = 2 AND sp.sp_quangcao IS NULL;
OTE;
                ...
                <div class="row nbat ">
                    ...
                    <?php foreach ($data as $item) : ?>
                        ...
                        <div class="col-md-3 col-xs-12 main-dt-nbat ">
                            <a href="sanphamlaptop.php?item=<?= $item['sp_ma'] ?>"><img src="/nguyenanhthoai/fontend/images/laptop/<?= $item['sp_hinh']; ?> " class="hinh-lp-nbat img-fluid mt-3 " onmouseenter="increaseSize(this) " onmouseout="decreaseSize(this) ">
                                <div class="card-body ">
